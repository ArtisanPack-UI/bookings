{{--
    The staff copy when a booking is confirmed. The details carry the customer's
    contact so a member of staff can act on the booking, and there is no manage
    link — the token is the customer's own credential.
