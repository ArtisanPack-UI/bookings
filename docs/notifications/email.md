...
Staff can be emailed a copy of the confirmation, cancellation, reschedule, and no-show notices too, off by default — see [Admin Email Copies](Notifications-Admin-Emails).
